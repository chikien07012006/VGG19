...
data_path = r"C:\Users\Administrator\Desktop\DATASET\Deep Learning\animals"
...
test = DataLoader(test, batch_size=2, shuffle=True)
...
data_path = r"/kaggle/input/aniaml/animals"
...
start_epoch = 0
acc = 0
if os.path.exists(r"/kaggle/working/last_cnn.pt"):
  checkpoint = torch.load(r"/kaggle/working/last_cnn.pt")
...
for i in range(start_epoch, 30):
  ...
  torch.save(checkpoint, r"/kaggle/working/last_cnn.pt")
  if accuracy > best_acc:
    ...
    torch.save(checkpoint, r"/kaggle/working/best_cnn.pt")
...
start_epoch = 0
acc = 0
if os.path.exists(r"C:\Users\Administrator\Desktop\DATASET\Deep Learning\trained_model_cnn\last_cnn.pt"):
  checkpoint = torch.load(r"C:\Users\Administrator\Desktop\DATASET\Deep Learning\trained_model_cnn\last_cnn.pt")
  start_epoch = checkpoint["epoch"]
  model.load_state_dict(checkpoint["model"])
  optimizer.load_state_dict(checkpoint["optimizer"])
  acc = checkpoint["acc"]
...
for i in range(start_epoch, 30):
  ...
  torch.save(checkpoint, r"C:\Users\Administrator\Desktop\DATASET\Deep Learning\trained_model_cnn\last_cnn.pt")
  if accuracy > best_acc:
    best_acc = accuracy
    checkpoint = {
    "model": model.state_dict(),
    ...
    torch.save(checkpoint, r"C:\Users\Administrator\Desktop\DATASET\Deep Learning\trained_model_cnn\best_cnn.pt")
